...
var G__40223 = current_node.parentNode;
var G__40224 = (sum_scroll_left + current_node.scrollLeft);
var G__40225 = (sum_scroll_top + current_node.scrollTop);
current_node = G__40223;
sum_scroll_left = G__40224;
sum_scroll_top = G__40225;
continue;
} else {
...
var vec__39991 = (cljs.core.truth_(size_only)?split_size_only:null);
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39991,(0),null);
var num = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39991,(1),null);
var units = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39991,(2),null);
...
while(true){
if((i__5770__auto___40242 < len__5769__auto___40240)){
...
(re_frisk.ui.components.splits.h_split.cljs$core$IFn$_invoke$arity$variadic = (function (p__40032){
var map__40034 = p__40032;
var map__40034__$1 = cljs.core.__destructure_map(map__40034);
var args = map__40034__$1;
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__40034__$1,new cljs.core.Keyword(null,"size","size",1098693007),"auto");
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40034__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40034__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40034__$1,new cljs.core.Keyword(null,"on-split-change","on-split-change",-1635241917));
var initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__40034__$1,new cljs.core.Keyword(null,"initial-split","initial-split",2072601727),(50));
var splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__40034__$1,new cljs.core.Keyword(null,"splitter-size","splitter-size",245247616),"8px");
var margin = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__40034__$1,new cljs.core.Keyword(null,"margin","margin",-995903681),"8px");
var document__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__40034__$1,new cljs.core.Keyword(null,"document","document",-1329188687),document);
...
var G__40047_40246 = cljs.core.deref(split_perc);
(on_split_change.cljs$core$IFn$_invoke$arity$1 ? on_split_change.cljs$core$IFn$_invoke$arity$1(G__40047_40246) : on_split_change.call(null,G__40047_40246));
} else {
}
...
return (function() { 
var G__40257__delegate = function (p__40088){
var map__40089 = p__40088;
var map__40089__$1 = cljs.core.__destructure_map(map__40089);
var _splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40089__$1,new cljs.core.Keyword(null,"_splitter-size","_splitter-size",-2092162822));
var panel_2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40089__$1,new cljs.core.Keyword(null,"panel-2","panel-2",244198907));
var panel_1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40089__$1,new cljs.core.Keyword(null,"panel-1","panel-1",998274139));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40089__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var _margin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40089__$1,new cljs.core.Keyword(null,"_margin","_margin",1508241828));
var _on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40089__$1,new cljs.core.Keyword(null,"_on-split-change","_on-split-change",1230437286));
var _width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40089__$1,new cljs.core.Keyword(null,"_width","_width",-75982426));
var _size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40089__$1,new cljs.core.Keyword(null,"_size","_size",-746489012));
var _height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40089__$1,new cljs.core.Keyword(null,"_height","_height",133867120));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40089__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var _initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40089__$1,new cljs.core.Keyword(null,"_initial-split","_initial-split",2145793073));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40089__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
while (G__40270__i < G__40270__a.length) {G__40270__a[G__40270__i] = arguments[G__40270__i + 0]; ++G__40270__i;}
  p__40088 = new cljs.core.IndexedSeq(G__40270__a,0,null);
} 
return G__40257__delegate.call(this,p__40088);};
G__40257.cljs$lang$maxFixedArity = 0;
G__40257.cljs$lang$applyTo = (function (arglist__40271){
var p__40088 = cljs.core.seq(arglist__40271);
return G__40257__delegate(p__40088);
});
...
/** @this {Function} */
(re_frisk.ui.components.splits.h_split.cljs$lang$applyTo = (function (seq40026){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq40026));
}));
...
var args__5775__auto__ = [];
var len__5769__auto___40275 = arguments.length;
var i__5770__auto___40276 = (0);
while(true){
if((i__5770__auto___40276 < len__5769__auto___40275)){
args__5775__auto__.push((arguments[i__5770__auto___40276]));

var G__40277 = (i__5770__auto___40276 + (1));
i__5770__auto___40276 = G__40277;
continue;
} else {
}
break;
...
(re_frisk.ui.components.splits.v_split.cljs$core$IFn$_invoke$arity$variadic = (function (p__40123){
var map__40124 = p__40123;
var map__40124__$1 = cljs.core.__destructure_map(map__40124);
var size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__40124__$1,new cljs.core.Keyword(null,"size","size",1098693007),"auto");
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40124__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40124__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40124__$1,new cljs.core.Keyword(null,"on-split-change","on-split-change",-1635241917));
var initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__40124__$1,new cljs.core.Keyword(null,"initial-split","initial-split",2072601727),(50));
var splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__40124__$1,new cljs.core.Keyword(null,"splitter-size","splitter-size",245247616),"8px");
var margin = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__40124__$1,new cljs.core.Keyword(null,"margin","margin",-995903681),"8px");
var document__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__40124__$1,new cljs.core.Keyword(null,"document","document",-1329188687),document);
...
var stop_drag = (function (){
if(cljs.core.truth_(on_split_change)){
var G__40156_40282 = cljs.core.deref(split_perc);
(on_split_change.cljs$core$IFn$_invoke$arity$1 ? on_split_change.cljs$core$IFn$_invoke$arity$1(G__40156_40282) : on_split_change.call(null,G__40156_40282));
} else {
}
...
return (function() { 
var G__40291__delegate = function (p__40181){
var map__40182 = p__40181;
var map__40182__$1 = cljs.core.__destructure_map(map__40182);
var _splitter_size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40182__$1,new cljs.core.Keyword(null,"_splitter-size","_splitter-size",-2092162822));
var panel_2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40182__$1,new cljs.core.Keyword(null,"panel-2","panel-2",244198907));
var panel_1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40182__$1,new cljs.core.Keyword(null,"panel-1","panel-1",998274139));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40182__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var _margin = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40182__$1,new cljs.core.Keyword(null,"_margin","_margin",1508241828));
var open_bottom_split_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40182__$1,new cljs.core.Keyword(null,"open-bottom-split?","open-bottom-split?",953160965));
var _on_split_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40182__$1,new cljs.core.Keyword(null,"_on-split-change","_on-split-change",1230437286));
var _width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40182__$1,new cljs.core.Keyword(null,"_width","_width",-75982426));
var _size = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40182__$1,new cljs.core.Keyword(null,"_size","_size",-746489012));
var close_bottom_split_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40182__$1,new cljs.core.Keyword(null,"close-bottom-split?","close-bottom-split?",1606756910));
var _height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40182__$1,new cljs.core.Keyword(null,"_height","_height",133867120));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40182__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var _initial_split = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40182__$1,new cljs.core.Keyword(null,"_initial-split","_initial-split",2145793073));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__40182__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
var p__40181 = null;
if (arguments.length > 0) {
var G__40320__i = 0, G__40320__a = new Array(arguments.length -  0);
while (G__40320__i < G__40320__a.length) {G__40320__a[G__40320__i] = arguments[G__40320__i + 0]; ++G__40320__i;}
  p__40181 = new cljs.core.IndexedSeq(G__40320__a,0,null);
} 
return G__40291__delegate.call(this,p__40181);};
G__40291.cljs$lang$maxFixedArity = 0;
G__40291.cljs$lang$applyTo = (function (arglist__40321){
var p__40181 = cljs.core.seq(arglist__40321);
return G__40291__delegate(p__40181);
});
...
/** @this {Function} */
(re_frisk.ui.components.splits.v_split.cljs$lang$applyTo = (function (seq40116){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq40116));
}));

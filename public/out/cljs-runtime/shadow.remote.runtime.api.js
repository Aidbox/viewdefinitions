...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_45433 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_45433(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_45441 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_45441(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_45449 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_45449(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_45459 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_45459(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_45482 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_45482(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_45488 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_45488(runtime,code);
}
});
...
var input = map__45409__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45409__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__45409__$1,new cljs.core.Keyword(null,"ns","ns",441598760));

...
var periods__$1 = cljs.core.vec((function (){var G__36393 = periods;
if(cljs.core.truth_(short_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36392_SHARP_){
return cljs.core.subs.cljs$core$IFn$_invoke$arity$3(p1__36392_SHARP_,(0),(3));
}),G__36393);
} else {
return G__36393;
}
...
cljs_time.internal.unparse.lookup = (function cljs_time$internal$unparse$lookup(p__36411){
var vec__36412 = p__36411;
var t = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36412,(0),null);
var pattern = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36412,(1),null);
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(t,new cljs.core.Keyword(null,"token","token",-1211463215))){
var G__36418 = pattern;
switch (G__36418) {
case "S":
...
return p1__36423_SHARP_.getMilliseconds();
});

break;
case "seconds":
return (function (p1__36424_SHARP_){
return p1__36424_SHARP_.getSeconds();
});

break;
case "minutes":
return (function (p1__36425_SHARP_){
return p1__36425_SHARP_.getMinutes();
});

break;
case "hours":
return (function (p1__36426_SHARP_){
return p1__36426_SHARP_.getHours();
});

break;
case "HOURS":
return (function (p1__36428_SHARP_){
return p1__36428_SHARP_.getHours();
});

break;
case "day":
return (function (p1__36429_SHARP_){
return p1__36429_SHARP_.getDate();
});

break;
case "month":
return (function (p1__36430_SHARP_){
return p1__36430_SHARP_.getMonth();
});

break;
case "year":
return (function (p1__36431_SHARP_){
return p1__36431_SHARP_.getYear();
});
...
cljs_time.internal.unparse.lookup_fn = (function cljs_time$internal$unparse$lookup_fn(syntax_list,i,p__36438){
...
var key = first__36441;
var args = seq__36440__$1;
var G__36443 = key;
...
break;
case "ordinal-suffix":
var vec__36447 = (function (){var G__36450 = (i - (1));
return (syntax_list.cljs$core$IFn$_invoke$arity$1 ? syntax_list.cljs$core$IFn$_invoke$arity$1(G__36450) : syntax_list.call(null,G__36450));
})();
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__36443__$1)].join('')));
...
var d = value;
var G__36456 = cljs.core.map_indexed.cljs$core$IFn$_invoke$arity$2(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs_time.internal.unparse.lookup_fn,syn_list),syn_list);
var vec__36457 = G__36456;
var seq__36458 = cljs.core.seq(vec__36457);
var first__36459 = cljs.core.first(seq__36458);
var seq__36458__$1 = cljs.core.next(seq__36458);
var unparser = first__36459;
var more = seq__36458__$1;
var s = "";
var d__$1 = d;
var G__36456__$1 = G__36456;
var s__$1 = s;
while(true){
var d__$2 = d__$1;
var vec__36471 = G__36456__$1;
...
var unparser__$1 = first__36473;
var more__$1 = seq__36472__$1;
var s__$2 = s__$1;
if((unparser__$1 == null)){
return s__$2;
} else {
var vec__36474 = (unparser__$1.cljs$core$IFn$_invoke$arity$2 ? unparser__$1.cljs$core$IFn$_invoke$arity$2(s__$2,d__$2) : unparser__$1.call(null,s__$2,d__$2));
var s__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36474,(0),null);
var d__$3 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36474,(1),null);
var G__36533 = d__$3;
var G__36534 = more__$1;
var G__36535 = s__$3;
d__$1 = G__36533;
G__36456__$1 = G__36534;
s__$1 = G__36535;
continue;
}
break;

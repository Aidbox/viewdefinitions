...
var i_39154 = (0);
while(true){
if((i_39154 < arr.length)){
(arr[i_39154] = null);

var G__39155 = (i_39154 + (1));
i_39154 = G__39155;
continue;
} else {
}
...
var i_39165 = (self__.level + (1));
while(true){
if((i_39165 <= (new_level + (1)))){
(update[i_39165] = self__.header);

var G__39167 = (i_39165 + (1));
i_39165 = G__39167;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_39168 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_39168[i]));
} else {
x__$2.forward.push((((i < links_39168.length))?(links_39168[i]):null));
}

if((i < links_39168.length)){
(links_39168[i] = x__$2);
} else {
links_39168.push(x__$2);
}
...
var i_39172 = (0);
while(true){
if((i_39172 <= self__.level)){
var links_39173 = (update[i_39172]).forward;
if((x__$1 === (((i_39172 < links_39173.length))?(links_39173[i_39172]):null))){
(links_39173[i_39172] = (x__$1.forward[i_39172]));

var G__39174 = (i_39172 + (1));
i_39172 = G__39174;
continue;
} else {
var G__39175 = (i_39172 + (1));
i_39172 = G__39175;
continue;
}
} else {
...
var G__39177 = nx;
var G__39178 = (level__$1 - (1));
x = G__39177;
level__$1 = G__39178;
continue;
} else {
var G__39179 = x;
var G__39180 = (level__$1 - (1));
x = G__39179;
level__$1 = G__39180;
continue;
}

...
var G__43960 = devtools.prefs.pref(v);
v = G__43960;
continue;
} else {
return v;
...
}catch (e43829){var _e__42502__auto__ = e43829;
return false;
}})();
...
}catch (e43833){var _e__42502__auto__ = e43833;
return false;
}})();
...
}catch (e43838){var _e__42502__auto__ = e43838;
return false;
}}
}
});
...
var vec__43859 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43859,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43859,(1),null);
...
return cljs.core.some((function (p1__43881_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__43881_SHARP_);
}),template);
});

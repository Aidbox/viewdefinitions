...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__32870 = c;
var G__32870__$1 = (((G__32870 == null))?null:G__32870.prototype);
if((G__32870__$1 == null)){
return null;
} else {
return G__32870__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__32881 = c;
var G__32881__$1 = (((G__32881 == null))?null:G__32881.prototype);
if((G__32881__$1 == null)){
return null;
} else {
return G__32881__$1.render;
}
})() == null)))));
});
...
var or__5045__auto__ = (function (){var G__32912 = c;
var G__32912__$1 = (((G__32912 == null))?null:G__32912.constructor);
if((G__32912__$1 == null)){
return null;
} else {
return G__32912__$1.displayName;
}
})();
...
var G__32932 = c;
var G__32932__$1 = (((G__32932 == null))?null:G__32932.constructor);
if((G__32932__$1 == null)){
return null;
} else {
return G__32932__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__32942 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__32943 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__32943);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__32942);
}});
...
var c = this;
var G__33005_33160 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__33005_33160 == null)){
} else {
reagent.ratom.dispose_BANG_(G__33005_33160);
}
...
var renders_33163 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_33164 = cljs.core.first(cljs.core.vals(renders_33163));
...
if((cljs.core.count(renders_33163) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_33163))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_33164)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_33164], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__33046 = o;
reagent.impl.component.goog$module$goog$object.set(G__33046,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__33085 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__33086 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__33086);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__33085);
}});
...
var vec__33094 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33094,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33094,(1),null);
...
var G__33104 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__33104 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__33104);
}
});
}),[]);

...
var G__33181 = o;
reagent.impl.template.goog$module$goog$object.set(G__33181,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__33200 = o;
reagent.impl.template.goog$module$goog$object.set(G__33200,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__33310__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
return G__33310__delegate.call(this,args);};
...
return G__33310__delegate(args);
});
...
var G__33215 = props;
var G__33215__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33215,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__33215);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33215__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5045__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__33226 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__33226,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__33226;
}
})(),id_class);
...
var G__33231 = (cljs.core.count(argv) - first_child);
switch (G__33231) {
case (0):
...
var vec__33245 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33245,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33245,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33245,(2),null);
...
var temp__5808__auto___33320 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___33320 == null)){
} else {
var key_33322 = temp__5808__auto___33320;
(jsprops.key = key_33322);
}
...
var temp__5808__auto___33325 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___33325 == null)){
} else {
var key_33327 = temp__5808__auto___33325;
(jsprops.key = key_33327);
}
...
var temp__5808__auto___33329 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___33329 == null)){
} else {
var key_33330 = temp__5808__auto___33329;
...
var temp__5808__auto___33348 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___33348 == null)){
} else {
var key_33350 = temp__5808__auto___33348;
(jsprops.key = key_33350);
}
...
var temp__5808__auto___33351 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___33351 == null)){
} else {
var key_33353 = temp__5808__auto___33351;
(jsprops.key = key_33353);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33273_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__33273_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__33274 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33274,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33274,(1),null);
...
var G__33287 = tag;
var G__33287__$1 = (((G__33287 instanceof cljs.core.Keyword))?G__33287.fqn:null);
switch (G__33287__$1) {
case ">":
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template33295 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template33295 = (function (opts,id,fn_to_element,parse_fn,meta33296){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template33295.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_33297,meta33296__$1){
var self__ = this;
var _33297__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template33295(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta33296__$1));
}));

(reagent.impl.template.t_reagent$impl$template33295.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_33297){
var self__ = this;
var _33297__$1 = this;
return self__.meta33296;
}));

(reagent.impl.template.t_reagent$impl$template33295.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template33295.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template33295.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template33295.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template33295.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template33295.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta33296","meta33296",-891975469,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template33295.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template33295.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template33295");

(reagent.impl.template.t_reagent$impl$template33295.cljs$lang$ctorPrWriter = (function (this__5330__auto__,writer__5331__auto__,opt__5332__auto__){
return cljs.core._write(writer__5331__auto__,"reagent.impl.template/t_reagent$impl$template33295");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template33295.
 */
reagent.impl.template.__GT_t_reagent$impl$template33295 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template33295(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta33296){
return (new reagent.impl.template.t_reagent$impl$template33295(opts__$1,id__$1,fn_to_element__$1,parse_fn__$1,meta33296));
});

}

return (new reagent.impl.template.t_reagent$impl$template33295(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});

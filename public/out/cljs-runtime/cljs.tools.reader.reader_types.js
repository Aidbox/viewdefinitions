...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_39548 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_39548(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_39549 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_39549(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_39552 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_39552(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_39557 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_39557(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_39562 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_39562(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_39566 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_39566(reader);
}
});
...
var G__39648 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__39649 = s.append(c);
c = G__39648;
s = G__39649;
continue;
}

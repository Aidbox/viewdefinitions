...
var G__38842 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(choices,new_index);
return (id_fn.cljs$core$IFn$_invoke$arity$1 ? id_fn.cljs$core$IFn$_invoke$arity$1(G__38842) : id_fn.call(null,G__38842));
} else {
return null;
}
});
...
var group_headers = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__38845_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword(null,"id","id",-1388402092),new cljs.core.Keyword(null,"group","group",582596132)],[cljs.core.gensym.cljs$core$IFn$_invoke$arity$0(),p1__38845_SHARP_]);
...
}catch (e38866){if((e38866 instanceof Object)){
var e = e38866;
return null;
} else {
throw e38866;
...
var G__38916_39085 = event.target.value;
(set_filter_text.cljs$core$IFn$_invoke$arity$1 ? set_filter_text.cljs$core$IFn$_invoke$arity$1(G__38916_39085) : set_filter_text.call(null,G__38916_39085));
 ...
 */
re_com.dropdown.filter_text_box = cljs.core.with_meta(re_com.dropdown.filter_text_box_base,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"component-did-mount","component-did-mount",-1126910518),(function (p1__38921_SHARP_){
var node = reagent.dom.dom_node(p1__38921_SHARP_).firstChild;
return node.focus();
}),new cljs.core.Keyword(null,"component-did-update","component-did-update",-1468549173),(function (p1__38922_SHARP_){
var node = reagent.dom.dom_node(p1__38922_SHARP_).firstChild;
return node.focus();
})], null));
/**
...
var text = (cljs.core.truth_(cljs.core.deref(internal_model))?(function (){var G__38924 = re_com.util.item_for_id.cljs$core$IFn$_invoke$arity$variadic(cljs.core.deref(internal_model),choices,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"id-fn","id-fn",316222798),id_fn], 0));
return (label_fn.cljs$core$IFn$_invoke$arity$1 ? label_fn.cljs$core$IFn$_invoke$arity$1(G__38924) : label_fn.call(null,G__38924));
})():placeholder);
...
var callback = (function (p__38939){
var map__38940 = p__38939;
var map__38940__$1 = cljs.core.__destructure_map(map__38940);
var args = map__38940__$1;
var result = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38940__$1,new cljs.core.Keyword(null,"result","result",1415092211));
var error = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38940__$1,new cljs.core.Keyword(null,"error","error",-978969032));
...
var G__38943 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"filter-text","filter-text",-381699202),text,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668),regex_filter_QMARK_], null);
var G__38944 = (function (p1__38935_SHARP_){
return callback(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"result","result",1415092211),p1__38935_SHARP_], null));
});
var G__38945 = (function (p1__38936_SHARP_){
return callback(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"error","error",-978969032),p1__38936_SHARP_], null));
});
return (choices.cljs$core$IFn$_invoke$arity$3 ? choices.cljs$core$IFn$_invoke$arity$3(G__38943,G__38944,G__38945) : choices.call(null,G__38943,G__38944,G__38945));
});
/**
...
var temp__5804__auto___39092 = new cljs.core.Keyword(null,"timer","timer",-1266967739).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state));
if(cljs.core.truth_(temp__5804__auto___39092)){
var timer_39094 = temp__5804__auto___39092;
clearTimeout(timer_39094);
} else {
}
...
var G__39104 = (i__5770__auto___39103 + (1));
i__5770__auto___39103 = G__39104;
continue;
} else {
}
break;
...
(re_com.dropdown.single_dropdown.cljs$core$IFn$_invoke$arity$variadic = (function (p__38971){
var map__38972 = p__38971;
var map__38972__$1 = cljs.core.__destructure_map(map__38972);
var args = map__38972__$1;
var choices = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38972__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var model = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38972__$1,new cljs.core.Keyword(null,"model","model",331153215));
var regex_filter_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38972__$1,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668));
var debounce_delay = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__38972__$1,new cljs.core.Keyword(null,"debounce-delay","debounce-delay",-608187982),(250));
...
var set_filter_text = (function (text,p__38974,debounce_QMARK_){
var map__38975 = p__38974;
var map__38975__$1 = cljs.core.__destructure_map(map__38975);
var args__$1 = map__38975__$1;
var regex_filter_QMARK___$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38975__$1,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668));
...
return (function() { 
var G__39109__delegate = function (p__38976){
var map__38977 = p__38976;
var map__38977__$1 = cljs.core.__destructure_map(map__38977);
var args__$1 = map__38977__$1;
var group_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__38977__$1,new cljs.core.Keyword(null,"group-fn","group-fn",129203707),new cljs.core.Keyword(null,"group","group",582596132));
var disabled_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38977__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38977__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var model__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38977__$1,new cljs.core.Keyword(null,"model","model",331153215));
var attr = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38977__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var label_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__38977__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263),new cljs.core.Keyword(null,"label","label",1718410804));
var tab_index = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38977__$1,new cljs.core.Keyword(null,"tab-index","tab-index",895755393));
var max_height = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38977__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var placeholder = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38977__$1,new cljs.core.Keyword(null,"placeholder","placeholder",-104873083));
var title_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38977__$1,new cljs.core.Keyword(null,"title?","title?",-1510254555));
var render_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__38977__$1,new cljs.core.Keyword(null,"render-fn","render-fn",398796518),label_fn);
var width = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38977__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var regex_filter_QMARK___$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38977__$1,new cljs.core.Keyword(null,"regex-filter?","regex-filter?",-824895668));
var choices__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38977__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__38977__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798),new cljs.core.Keyword(null,"id","id",-1388402092));
var style = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38977__$1,new cljs.core.Keyword(null,"style","style",-496642736));
var debounce_delay__$1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38977__$1,new cljs.core.Keyword(null,"debounce-delay","debounce-delay",-608187982));
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38977__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
var filter_box_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__38977__$1,new cljs.core.Keyword(null,"filter-box?","filter-box?",-1157583688));
...
var callback = (function (p1__38956_SHARP_){
cljs.core.reset_BANG_(internal_model,p1__38956_SHARP_);
...
var G__38981_39113 = cljs.core.deref(internal_model);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__38981_39113) : on_change.call(null,G__38981_39113));
} else {
}
...
var G__38986_39119 = cljs.core.deref(internal_model);
(on_change.cljs$core$IFn$_invoke$arity$1 ? on_change.cljs$core$IFn$_invoke$arity$1(G__38986_39119) : on_change.call(null,G__38986_39119));
} else {
}
...
var key_handler = (function (p1__38961_SHARP_){
if(cljs.core.truth_(disabled_QMARK___$1)){
return false;
} else {
var G__38995 = p1__38961_SHARP_.which;
switch (G__38995) {
case (13):
return press_enter();
...
})())?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"li.error","li.error",534172652),new cljs.core.Keyword(null,"error","error",-978969032).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(choices_state))], null):(((cljs.core.count(filtered_choices) > (0)))?(function (){var vec__39000 = re_com.dropdown.choices_with_group_headings(filtered_choices,group_fn);
var group_names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39000,(0),null);
var group_opt_lists = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39000,(1),null);
...
var make_choices = (function (p1__38964_SHARP_){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(make_a_choice,p1__38964_SHARP_);
});
...
while (G__39140__i < G__39140__a.length) {G__39140__a[G__39140__i] = arguments[G__39140__i + 0]; ++G__39140__i;}
  p__38976 = new cljs.core.IndexedSeq(G__39140__a,0,null);
} 
return G__39109__delegate.call(this,p__38976);};
G__39109.cljs$lang$maxFixedArity = 0;
G__39109.cljs$lang$applyTo = (function (arglist__39141){
var p__38976 = cljs.core.seq(arglist__39141);
return G__39109__delegate(p__38976);
});
...
/** @this {Function} */
(re_com.dropdown.single_dropdown.cljs$lang$applyTo = (function (seq38965){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq38965));
}));

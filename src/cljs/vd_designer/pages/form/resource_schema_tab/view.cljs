(ns vd-designer.pages.form.resource-schema-tab.view
  (:require ["@ant-design/icons" :as icons]
            ...
            [vd-designer.pages.form.resource-schema-tab.components :as components]
            [vd-designer.pages.form.resource-schema-tab.model :as m]
            [vd-designer.pages.form.resource-schema-tab.controller :as c]))
  ...
  (let [spec @(subscribe [::m/spec-map])
    ...
    (if resource
      [tree {:style            {:padding-right "10px"}
             ...
             :class            "vd-tree resource-schema-tab"
